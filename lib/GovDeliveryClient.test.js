...
require("jest");
var GovDeliveryClient_1 = require("./GovDeliveryClient");
var models_1 = require("./models");
var request = __importStar(require("request-promise-native"));
jest.mock('request-promise-native', function () {
    return {
        post: jest.fn(function (options) { return Promise.resolve({}); })
    };
});
describe("KongClient", function () {
    ...
    var user;
    beforeEach(function () {
        client = new GovDeliveryClient_1.GovDeliveryClient({
            token: 'fakeKey',
    ...
    describe('constructor', function () {
        test('it should render the handlebars template', function () { return __awaiter(void 0, void 0, void 0, function () {
            var template, html;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client.welcomeTemplate];
                    case 1:
                        template = _a.sent();
                        html = template({
        ...
        test('it should render the handlebars template with health and verification', function () { return __awaiter(void 0, void 0, void 0, function () {
            var template, html;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client.welcomeTemplate];
    ...
    describe('sendWelcomeEmail', function () {
        test('it should sent a request', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client.sendWelcomeEmail(user)];
                    case 1:
                        _a.sent();
        ...
        test('it should raise error if user lacks token', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
